...
var ScoresComponent = /** @class */ (function () {
    ...
    ScoresComponent.prototype.displayScoreGrid = function () {
        var _this = this;
        this.studentGridServerSuccessMessage = "";
    ...
    ScoresComponent.prototype.populateL1Grid = function () {
    };
    ScoresComponent.prototype.populateL2Grid = function () {
        var _this = this;
        this.showL2Grid = false;
    ...
    ScoresComponent.prototype.populateL3Grid = function () {
        var _this = this;
        this.showL3Grid = false;
        if (this.selectedTermWeekId != 0 && this.selectedGrade != "0" && this.selectedTeacherId != 0) {
            this.isStudentTermScoreGridLoading = true;
...
var StudentService = /** @class */ (function () {
    ...
    StudentService.prototype.saveStudentTestScores = function (gradeLevel, studentTermScores) {
        var data = {
            gradeLevel: gradeLevel,
...
var TeacherService = /** @class */ (function () {
    ...
    //    return this._http.get<StudentWeekGrade[]>('/api/Teacher/assignmentById/' + teacherId + '/studentgrades/' + weekId);
    //}
    TeacherService.prototype.getStudentTermScores = function (teacherId, gradeLevel, termNo, weekId) {
        return this._http.get('/api/Teacher/assignmentById/' + teacherId + '/' + gradeLevel + '/studentscores/' + termNo + '/' + weekId);
    };
